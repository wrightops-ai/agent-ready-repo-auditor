...
def build_comment(report: AuditReport) -> str:
    ...
    return (
        ...
        "fix-plan-request.yml). Automated preflight verifies the audit and repository; "
        "WrightOps then confirms fixed-scope eligibility within one business day. Use the "
        "dedicated [PayPal goods/services checkout](https://www.paypal.com/ncp/payment/"
        "H9VVRGRGA3DCG) only after that confirmation. Do not pay before confirmation or "
        "post payment details here.\n\n"
